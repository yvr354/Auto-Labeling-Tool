  ...
  const loadAnalytics = async () => {
    ...
    try {
      ...
      const [classResp, splitResp, imbalanceResp, progressResp] = await Promise.all([
        fetch(`/api/analytics/dataset/${datasetId}/class-distribution`),
        fetch(`/api/analytics/dataset/${datasetId}/split-analysis`),
        fetch(`/api/analytics/dataset/${datasetId}/imbalance-report`),
        fetch(`/api/analytics/dataset/${datasetId}/labeling-progress`)
      ]);
